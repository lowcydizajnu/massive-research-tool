...
4. The author fills **authored sections** — Abstract (required to publish public), Results narrative, **Article link / DOI**, and any custom content blocks — by drag-and-drop from a section palette.
...
- **Trigger:** study later amended / reopened for more data. **System response:** Record shows a "superseded — newer version exists" note; finishing again refreshes it.
