 ...
 */
export type CompareNodeData = { label: string; ref?: string; status: CompareStatus };
...
export function CompareBlockNode({ data }: NodeProps<CompareNodeType>) {
  ...
  return (
    <div
      className="flex min-w-[170px] max-w-[230px] flex-col gap-0.5 rounded-[var(--radius-md)] bg-[var(--color-surface-canvas)] px-3 py-2"
