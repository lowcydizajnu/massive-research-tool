...
const COMING_SOON: Record<Exclude<TabKey, "modules">, string> = {
  ...
  templates: "Reusable study templates will live here once save-as-template ships.",
      ...
      {tab === "modules" ? (
        ...
        <div className="flex flex-col items-start gap-2 rounded-[var(--radius-md)] bg-[var(--color-surface-subtle)] p-8">
          ...
          <p className="max-w-prose text-[length:var(--text-body)] text-[var(--color-text-secondary)]">
            {COMING_SOON[tab as Exclude<TabKey, "modules">]}
          </p>
        </div>
      )}
    </main>
