        ...
        {s.screen.blocks.map((b) => {
          ...
          return (
            <div key={b.instanceId}>
              ...
              <BlockView block={b} seed={sessionId} namePrefix={prefix} presetKey={effectivePresetKey(s.theme)} responseId={sessionId} chat={resolveChat(s.theme)} blockCopy={s.blockCopy} />
            </div>
          );
        })}
