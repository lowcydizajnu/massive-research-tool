# My Research Lab — propozycja partnerstwa / partnership proposal

> **Jak używać / How to use:** dwujęzyczny szablon. Wybierz wersję językową adekwatną do odbiorcy, podmień placeholders w nawiasach kwadratowych — szczególnie sekcję *Co My Research Lab robi dobrze dla Państwa lab* / *Where My Research Lab is uniquely strong for your lab*, która jest najważniejszym elementem pitchu i powinna być personalizowana per odbiorca (1-2 zdania nawiązujące do ich publikacji). Wysyłaj jako PDF (eksport z Marked / Typora / pandoc) lub wklej do treści emaila. Długość intencjonalna: jedna strona A4 po wydruku.

---

# 🇵🇱 Wersja polska

**My Research Lab — propozycja partnerstwa naukowo-rozwojowego**

Szanowna/y [Pani Profesor / Panie Profesorze NAZWISKO],

Piszę z propozycją partnerstwa rozwojowego dla zespołu z [INSTYTUCJA / Katedra / Lab]. Jestem niezależnym programistą i twórcą **My Research Lab** ([myresearchlab.app](https://myresearchlab.app)) — platformy do projektowania, preregistracji, prowadzenia i analizy eksperymentów psychologicznych online.

## Czym jest My Research Lab
...
[**SLOT DO PERSONALIZACJI** — 1-2 zdania nawiązujące do konkretnych publikacji odbiorcy. Przykład: "Państwa praca nad asymetrią reakcji emocjonalnych na dezinformację (Kowalski & Nowak, 2024) jest dokładnie tym typem badania, do którego My Research Lab został zaprojektowany — voice-response + emotion-scoring w jednym workflow, z preregistracją i replikowalnością wbudowanymi w platformę."]
...
- **Dedykowaną instancję My Research Lab** dostosowaną do potrzeb lab (dodatkowe typy bloków, integracje, workflow)
...
- **5 lat bezpłatnej licencji instytucjonalnej** gdy My Research Lab przejdzie na model subskrypcyjny (wartość: ~750 tys. PLN przy planowanej cenie)
...
Stabilne finansowanie pozwalające na pełnoetatową pracę nad My Research Lab; walidację rynkową przed szerszą komercjalizacją; pierwszego referencyjnego klienta instytucjonalnego; realny feedback z prawdziwych badań.
...
**Paweł Rosner** — niezależny developer-przedsiębiorca. My Research Lab to mój główny projekt; w trakcie partnerstwa nie obsługuję innych klientów. Operuję jako sp. z o.o. (faktury VAT). Email: [adres], LinkedIn: [link], demo na żywo: [myresearchlab.app](https://myresearchlab.app).
...
**My Research Lab — Research Partnership Proposal**

Dear [Prof. NAME],

I'm writing to propose a development partnership with your team at [INSTITUTION / Department / Lab]. I'm an independent developer and the creator of **My Research Lab** ([myresearchlab.app](https://myresearchlab.app)) — a platform for designing, preregistering, running, and analyzing online psychological experiments.

## What My Research Lab is
...
[**PERSONALIZATION SLOT** — 1-2 sentences referencing the recipient's specific publications. Example: "Your work on asymmetric emotional reactions to misinformation (Smith & Jones, 2024) is exactly the type of research My Research Lab was designed for — voice-response + emotion-scoring in one workflow, with preregistration and replicability built into the platform."]
...
- **Dedicated My Research Lab instance** customized to your lab's needs (additional block types, integrations, workflows)
...
- **5-year free institutional license** once My Research Lab moves to a subscription model (value: ~$200k at planned pricing)
- **Co-authorship on case study** + your logo in the "Trusted by" section
- **Co-decision on roadmap** — you set priorities for 12 months

## What I receive

Stable funding enabling full-time work on My Research Lab; market validation before broader commercialization; first institutional reference customer; real feedback from actual research.
...
**Paweł Rosner** — independent developer-entrepreneur. My Research Lab is my primary project; I do not take on other clients during a partnership engagement. Operating as a Polish limited liability company (full VAT invoicing). Email: [address], LinkedIn: [link], live demo at [myresearchlab.app](https://myresearchlab.app).
...
- [ ] Filled `SLOT DO PERSONALIZACJI` / `PERSONALIZATION SLOT` with 1-2 sentences linking My Research Lab capabilities to recipient's specific published work — this is the most important sentence in the whole pitch
...
4. **The personalization slot is non-negotiable.** Don't send the template with that field empty — they'll see it. If you can't find an angle that genuinely connects My Research Lab to the recipient's work, they're not the right partner; skip and find another PI.
