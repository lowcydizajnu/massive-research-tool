...
| Vercel | App hosting | EU (Frankfurt) | Request/response traffic; no direct DB access |
...
- **My Research Lab operators** can use a read-only **"View as"** support tool — but it is deliberately constrained (see below).
...
<Frame caption="Workspace admins can switch off platform-operator support access entirely for sensitive work.">
  <img src="/images/trust/privacy.png" alt="The workspace privacy setting for support access" />
</Frame>
...
<Frame caption="Export your dataset any time — choose, rename, and preview variables, then download CSV / SPSS / Stata.">
  <img src="/images/methodology/results-export.png" alt="The Export data page with the variable configurator and row preview" />
</Frame>
