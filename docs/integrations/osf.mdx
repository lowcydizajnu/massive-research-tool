...
<Frame caption="The Preregister stage — your OSF connection, the template you're filing under, and a readiness check that names every unanswered mandatory OSF question before you push.">
  <img src="/images/integrations/preregister.png" alt="The Preregister stage: OSF connected, filing as OSF preregistration, and a Readiness check listing the unanswered mandatory OSF questions with an Answer these link, above the Preregister button" />
</Frame>
...
| Field of study (if chosen) | Draft registration `subjects` (OSF taxonomy) |
| Your answers to the chosen template's questions | The template's registration fields |
| Abstract, hypotheses, typed plan fields, protocol narrative *(Open-Ended)* | Registration summary (prose) |
...
| Derivation disclosure (if variables were read from your design) | Registration summary |
...
<Note>
Some persistent identifiers live on your **public record**, not in the OSF push — your study's **language**, its **funders**, and your affiliation's **ROR** id. See [Findability](/methodology/findability) for how those are captured and surfaced.
</Note>
